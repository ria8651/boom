...
export default function ControlBar({ chatOpen, onToggleChat, unreadChat, layoutMode, onLayoutModeChange, screenShareSettings, onScreenShareSettingsChange, theme, onThemeChange, pipSupported, pipActive, onTogglePip, onInvite }: ControlBarProps) {
